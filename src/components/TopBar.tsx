...
export default function TopBar({ title = 'Астана баспана', showBack, showMenu }: TopBarProps) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <div style={{
          width: 28, height: 28, borderRadius: 8, background: '#D4AF3720',
      ...
      <button onClick={() => navigate('/profile')} style={{
        ...
        border: '2px solid #D4AF37', cursor: 'pointer', padding: 0, background: 'none',
      }}>
